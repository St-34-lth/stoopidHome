...
if __name__ == "__main__":
    ...
    ca_certs = os.path.join(package_path, "ss", "ca.crt")         # CA certificate file
    certfile = os.path.join(package_path, "ss", "client.crt")       # (optional) client certificate
    keyfile = os.path.join(package_path, "ss", "client.key")  
    mqtt_client.tls_set(
